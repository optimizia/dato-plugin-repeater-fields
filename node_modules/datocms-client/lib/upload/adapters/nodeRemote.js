  ...
  var promise = new Promise(function (resolve, reject) {
    ...
    return _tmp["default"].dir(function (err, dir, cleanupCallback) {
      ...
      request.then(function (response) {
        var _url$parse = _url["default"].parse((0, _decode["default"])(response.url)),
        ...
        if (error instanceof _got["default"].CancelError) {
          ...
          reject(new Error("Invalid status code for ".concat(encodedFileUrl, ": ").concat(error.response.statusCode)));
        } else {
          reject(error);
        }
      });
