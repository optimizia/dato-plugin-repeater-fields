...
function _runPendingMigrations() {
  _runPendingMigrations = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var sourceEnvId, destinationEnvId, migrationModelApiKey, relativeMigrationsDir, inPlace, cmaBaseUrl, tokenByArg, migrationsDir, allMigrations, token, globalClient, allEnvironments, primaryEnv, sourceEnv, environmentId, forkSpinner, existingEnvironment, client, migrationModel, alreadyRunMigrations, migrationsToRun, _iterator, _step, migrationFile, migrationAbsolutePath, migration, migrationSpinner;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            sourceEnvId = _ref.sourceEnvId, destinationEnvId = _ref.destinationEnvId, migrationModelApiKey = _ref.migrationModelApiKey, relativeMigrationsDir = _ref.relativeMigrationsDir, inPlace = _ref.inPlace, cmaBaseUrl = _ref.cmaBaseUrl, tokenByArg = _ref.token;
          ...
          case 18:
            ...
            environmentId = inPlace ? sourceEnv.id : destinationEnvId || "".concat(sourceEnv.id, "-post-migrations");
          ...
          case 23:
            process.stdout.write("Migrations will be run in sandbox env `".concat(environmentId, "`\n"));
            _context.next = 34;
            break;

          case 26:
            forkSpinner = (0, _ora["default"])("Creating a fork of `".concat(sourceEnv.id, "` called `").concat(environmentId, "`...")).start();
            ...
            forkSpinner.fail();
            throw new Error("Environment ".concat(environmentId, " already exists! If you want to run the migrations inside this existing environment you can add the --inPlace flag."));
